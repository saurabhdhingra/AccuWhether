...
//    static var tabBarBorder = Color("Tab Bar Border").opacity(0.5)
//    static var forecastCardBackground = Color("Forecast Card Background")
//    static var probabilityText = Color("Probability Text")
}
